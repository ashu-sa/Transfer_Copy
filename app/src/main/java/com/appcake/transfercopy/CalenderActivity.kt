...
class CalenderActivity : AppCompatActivity(), CalendarDateAdapter.RecyclerViewClickListener {
    ...
    private fun setMonthView() {
        ...
        val adapter = CalendarDateAdapter(daysInMonthArray, this@CalenderActivity)
    ...
    fun getEvents(): ArrayList<GoogleCalendar> {
        ...
        val calendercursor: Cursor =
            this@CalenderActivity.contentResolver.query(uri, columns, null, null, "")!!

        if (calendercursor != null)
            if (calendercursor.moveToNext())
                do {
                    val date =
                        calendercursor.getString(calendercursor.getColumnIndex(CalendarContract.Events.DTSTART))
                            .toLong()
                    val title =
                        calendercursor.getString(calendercursor.getColumnIndex(CalendarContract.Events.TITLE))
    ...
    override fun onClick(position: Int,dateText:TextView) {
           dateText.setTextColor(Color.WHITE)
           Toast.makeText(this@CalenderActivity,"Clicked", Toast.LENGTH_SHORT).show()
